...
require_relative '../hourly/add_time_card'
require_relative '../comissioned/add_employee'
require_relative '../comissioned/add_sales_receipt'
require_relative '../union/affiliate'
require_relative '../union/add_service_charge'
require 'date'
...
describe Payday do
  ...
  describe 'salaried classification' do
  ...
  describe 'hourly classification' do
  ...
  describe 'comissioned classification' do
